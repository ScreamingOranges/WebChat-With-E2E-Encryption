...
<?php
    class users {
        ...
        function setPass($password){$this->password = password_hash($password, PASSWORD_DEFAULT); }
        ...
        {
            $sql = "INSERT INTO `users`(`id`, `name`, `email`, `login_status`, `last_login`, `password`) VALUES (null, :name, :email, :loginStatus, :lastLogin, :password)";
